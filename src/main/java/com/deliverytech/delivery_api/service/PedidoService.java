...
public class PedidoService {
    ...
    public PedidoService(PedidoRepository pedidoRepository, ClienteRepository clienteRepository, RestauranteRepository restauranteRepository, 
        ItemPedidoRepository itemPedidoRepository, ModelMapper mapper, ProdutoRepository produtoRepository) {
    ...
    public PedidoResponseDTO atualizarStatus(Long pedidoId){
        ...
        switch(statusAtual){
            ...
            case CANCELADO, ENTREGUE -> 
                throw new BusinessException("Status do Pedido não pode ser atualizado.");
            default ->
                throw new BusinessException("Status é inválido.");
        }
        return toResponseDTO(pedido);
    }
